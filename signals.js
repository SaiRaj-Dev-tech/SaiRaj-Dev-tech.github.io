            ...
            return function(g, b, c, d) {
                ...
                (function() {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsGuardrail")
                      ...
                      , l = f.getFbeventsModules("SignalsFBEventsExperimentNames")
                      , m = l.PROCESS_BUTTON_CLICK_OPTIMIZE;
                    l = f.getFbeventsModules("SignalsFBEventsEvents");
                    var n = l.fired
                      , o = l.piiConflicting
                      , p = l.extractPii;
                    l = f.getFbeventsModules("SignalsFBEventsShared");
                    var q = l.signalsConvertNodeToHTMLElement
                      , r = l.signalsExtractForm
                      , s = l.signalsIsIWLElement
                      , t = l.signalsExtractButtonFeatures
                      , u = l.signalsGetTruncatedButtonText
                      , v = l.signalsGetWrappingButton;
                    l = f.getFbeventsModules("SignalsFBEventsPlugin");
                    var w = f.getFbeventsModules("SignalsFBEventsThrottler")
                      , x = f.getFbeventsModules("SignalsFBEventsUtils")
                      , y = f.getFbeventsModules("signalsFBEventsExtractEventPayload")
                      , z = f.getFbeventsModules("signalsFBEventsMakeSafe")
                      , A = f.getFbeventsModules("signalsFBEventsMakeSafeString")
                      , B = x.each
                      , C = x.keys
                      , D = f.getFbeventsModules("signalsFBEventsExtractFromInputs")
                      , E = new w()
                      , F = f.getFbeventsModules("signalsFBEventsDoAutomaticMatching")
                      , G = 100;
                    function H(a, b) {
                    ...
                    function I(b) {
                        return function(e) {
                            if (b.disableAutoConfig)
                                return;
                            var f = e.target instanceof Node ? q(e.target) : null;
                            if (f != null) {
                                if (s(f))
                                    return;
                                if (!E.passesThrottle(f))
                                    return;
                                e = b.getOptedInPixels("InferredEvents");
                                B(e, function(e) {
                                    var g = c.get(e.id, "inferredEvents")
                                      , i = !1;
                                    g != null && g.disableRestrictedData != null && (i = g.disableRestrictedData);
                                    g = H(e.id, g);
                                    var j = void 0
                                      , k = a.eval("enable_button_click_optimize_experiment", e.id);
                                    k ? (j = v(f, g, !1),
                                    j == null && d.isInTest(m) && (j = v(f, g, !0))) : j = v(f, g, !0);
                                    if (j == null)
                                        return;
                                    k = b.optIns.isOptedIn(e.id, "AutomaticMatching");
                                    g = a.eval("sgw_auto_extract", e.id) && b.optIns.isOptedIn(e.id, "OpenBridge");
                                    var l = r(j)
                                      , n = t(j, l)
                                      , p = n ? n.innerText : null;
                                    p = A(p != null ? p : u(j)).safe;
                                    if (p != null && p.length > G)
                                        return;
                                    var q = k || g;
                                    j = y({
                                        button: j,
                                    ...
                                    l == null && o.trigger(e);
                                    k && l != null && F(b, e, l, q || {});
                                    g && l != null && (e.sgwUserDataFormFields = l);
                                    if (i && (e.userDataFormFields == null || C(e.userDataFormFields).length === 0) && (e.sgwUserDataFormFields == null || C(e.sgwUserDataFormFields).length === 0))
                                        return;
                                    b.trackSingleSystem("automatic", e, "SubscribedButtonClick", p)
                                })
                            }
                        }
                    }
                    function J(a, c, d, e, f) {
                        ...
                        g == null ? o.trigger(c) : F(a, c, g, d || {}, f)
                    }
                    x = function(a) {
                        j(b, a);
                        function b() {
...
fbq.registerPlugin("251025992170426", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        config.set("251025992170426", "inferredEvents", {
            "buttonSelector": null,
            "disableRestrictedData": false
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("251025992170426", "InferredEvents", true);
        config.set("251025992170426", "automaticMatching", {
            "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("251025992170426", "AutomaticMatching", true);
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("251025992170426", "IWLBootstrapper", true);
        config.set("251025992170426", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("251025992170426", "FirstPartyCookies", true);
        fbq.loadPlugin("inferredevents");
        instance.optIn("251025992170426", "InferredEvents", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("251025992170426", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("251025992170426", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("251025992170426", "ProhibitedSources", true);
        config.set("251025992170426", "unwantedData", {
            "blacklisted_keys": {
                "StartRegistration": {
                    "cd": [],
                    "url": ["firstname", "password"]
                },
                "PageView": {
                    "cd": [],
                    "url": ["password", "firstname"]
                },
                "Download": {
                    "cd": [],
                    "url": ["firstname", "password"]
            ...
            "sensitive_keys": {
                "StartRegistration": {
                    "cd": [],
                    "url": ["2bcb43cbc8f6b7ef66331532881143fcbae60a879db3a8fb853f645bb24c2b3c"]
                },
                "PageView": {
                    "cd": [],
                    "url": ["2bcb43cbc8f6b7ef66331532881143fcbae60a879db3a8fb853f645bb24c2b3c"]
        ...
        instance.optIn("251025992170426", "UnwantedData", true);
        config.set("251025992170426", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("251025992170426", "IABPCMAEBridge", true);
        config.set("251025992170426", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("251025992170426", "BrowserProperties", true);
        config.set("251025992170426", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("251025992170426", "EventValidation", true);
        config.set("251025992170426", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("251025992170426", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("251025992170426", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("251025992170426", "CookieDeprecationLabel", true);
        fbq.loadPlugin("unwantedparams");
        instance.optIn("251025992170426", "UnwantedParams", true);
        fbq.loadPlugin("standardparamchecks");
        instance.optIn("251025992170426", "StandardParamChecks", true);
        fbq.loadPlugin("topicsapi");
        instance.optIn("251025992170426", "TopicsAPI", true);
        config.set("251025992170426", "gating", {
            "gatings": [{
                ...
                "name": "enable_shopify_order_id",
                "passed": true
            }]
        });
        fbq.loadPlugin("gating");
        instance.optIn("251025992170426", "Gating", true);
        instance.configLoaded("251025992170426");
    }
});
